...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'links_link', 'url_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['links.Url']))

    def backwards(self, orm):

        # Changing field 'Link.url'
        db.alter_column(u'links_link', 'url_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['links.Url'], null=True))
