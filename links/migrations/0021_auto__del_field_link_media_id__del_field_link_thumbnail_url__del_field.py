...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'links_link', 'media_id')

        # Deleting field 'Link.thumbnail_url'
        db.delete_column(u'links_link', 'thumbnail_url')

        # Deleting field 'Link.media_type'
        db.delete_column(u'links_link', 'media_type')


    def backwards(self, orm):
        # Adding field 'Link.media_id'
        db.add_column(u'links_link', 'media_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Link.thumbnail_url'
        db.add_column(u'links_link', 'thumbnail_url',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Link.media_type'
        db.add_column(u'links_link', 'media_type',
