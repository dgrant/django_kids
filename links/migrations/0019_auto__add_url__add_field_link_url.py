...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Url'
        db.create_table(u'links_url', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('media_type', self.gf('django.db.models.fields.CharField')(default='youtube', max_length=50)),
            ('media_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('thumbnail_url', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
        ))
        db.send_create_signal(u'links', ['Url'])

        # Adding field 'Link.url'
        db.add_column(u'links_link', 'url',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['links.Url'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Url'
        db.delete_table(u'links_url')

        # Deleting field 'Link.url'
        db.delete_column(u'links_link', 'url_id')
    ...
    models = {
        ...
        u'links.link': {
            ...
            'url': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['links.Url']", 'null': 'True'}),
