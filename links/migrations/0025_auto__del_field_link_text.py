...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Link.text'
        db.delete_column(u'links_link', 'text')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Link.text'
        raise RuntimeError("Cannot reverse this migration. 'Link.text' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Link.text'
        db.add_column(u'links_link', 'text',
